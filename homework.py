...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        return ((self.coeff_running_1 * self.get_mean_speed()
                 - self.coeff_running_2) * self.weight / self.M_IN_KM
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self):
        return ((self.coeff_walking_1 * self.weight + (
            ...
            * self.coeff_walking_2 * self.weight) * self.duration * self.MIN)
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        return ((self.get_mean_speed() + self.coef_swimming_1)
                * self.coef_swimming_2 * self.weight)
